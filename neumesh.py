...
class NeuMesh(nn.Module):
    def __init__(
        ...
        self.embed_fn_view, input_ch_view = get_embedder(multires_view, input_dim=input_view_dim)
        self.embed_fn_fg, input_ch_fg = get_embedder(multires_fg, input_dim=geometry_dim)
