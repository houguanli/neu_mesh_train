...
class Runner:
    ...
    def validate_mesh(self, world_space=False, resolution=64, threshold=0.0, specified_path=None):
        ...
        if specified_path is None:
            ...
            mesh.export(specified_path, encoding='ascii')
            print("save at " + specified_path)
